...
module Counter
  ...
  LUT6 #(
    ...
    \acounto[31]_i_1 
       (.I0(cdone_INST_0_i_5_n_1),
        .I1(cdone_INST_0_i_4_n_1),
        .I2(cdone_INST_0_i_3_n_1),
        .I3(cdone_INST_0_i_2_n_1),
        .I4(cdone_INST_0_i_1_n_1),
        .I5(clr),
  ...
  FDRE #(
    ...
    \count_reg[9] 
       (.C(clk),
        ...
        .Q(count_reg[9]),
        .R(clr));
  BUFG n_0_12_BUFG_inst
       (.I(n_0_12_BUFG_inst_n_1),
        .O(n_0_12_BUFG));
  LUT1 #(
    .INIT(2'h1)) 
    n_0_12_BUFG_inst_i_1
       (.I0(count2),
        .O(n_0_12_BUFG_inst_n_1));
  FDRE \rcounto_reg[0] 
       (.C(clk),
        .CE(cdone),
        .D(count_reg[0]),
...
(* ECO_CHECKSUM = "a6874704" *) (* S0 = "4'b0000" *) (* S1 = "4'b0001" *) 
...
module enhancedCROwrap
  ...
  cro crores
       (.clk(clk_IBUF_BUFG),
        .clr(croclr),
        .cpdl({\tsecp_reg_n_1_[2] ,\tsecp_reg_n_1_[1] ,\tsecp_reg_n_1_[0] }),
        .croout(rout0),
  ...
  uartmodDRC uart64
       (.gosen(gosen),
        .rddata({rddata[63:43],\<const0> ,\<const0> ,\<const0> ,rddata[32],rddata[32],rddata[32],rddata[32],rddata[32],rddata[32],rddata[32],rddata[32:0]}),
        .txd(txd_OBUF),
        .uartRdy(uartRdy),
        .uartclk(uartclk),
        .uartdone(uartdone));
