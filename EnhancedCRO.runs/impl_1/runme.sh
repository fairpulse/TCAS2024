...
HD_PWD='/opt/Xilinx/Vivado/2018.1/bin/EnhancedCRO/EnhancedCRO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enhancedCROwrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enhancedCROwrap.tcl -notrace
