...
HD_PWD='/opt/Xilinx/Vivado/2018.1/bin/EnhancedCRO/EnhancedCRO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enhancedCROwrap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enhancedCROwrap.tcl
